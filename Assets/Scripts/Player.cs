...
public class Player : MonoBehaviour
{
    ...
    void CalculatePath()
    {
        ...
        float verticalOffset = UnityEngine.Random.Range(-2f, 2f);
    ...
    private void HandleAutoNavigation()
    {
        ...
        else if (currentPath.Count == 0 && !isBlocked)
        {
    ...
    public void CheckGameOver(int energy)
    {
        if (energy <= 0)
        {
    ...
    public void PlayerCrossedFlags()
    {
